...
@Autonomous(name="Emergency Backup Blue", group="Iterative Opmode")


public class JustInCaseBlue extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        */
        ...
        while (runtime.milliseconds() < 600) {
            leftFrontWheel.setPower(-0.75);
            leftBackWheel.setPower(-0.75);
            rightFrontWheel.setPower(0.75);
            rightBackWheel.setPower(0.75);
        } 
        while(runtime.milliseconds() < 1000) {
            leftFrontWheel.setPower(0);
            leftBackWheel.setPower(0);
        ...
        while(runtime.milliseconds() < 2850) { 
            leftFrontWheel.setPower(-0.75);
            leftBackWheel.setPower(-.75);
            rightFrontWheel.setPower(-.75);
            rightBackWheel.setPower(-.75);
        }
        leftFrontWheel.setPower(0);
        leftBackWheel.setPower(0);
        rightFrontWheel.setPower(0);
